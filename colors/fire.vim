...
hi Pmenu guifg=#c8c6c5 guibg=#256295 gui=NONE cterm=NONE
hi PmenuSbar guifg=#c8c6c5 guibg=#256295 gui=NONE cterm=NONE
hi PmenuSel guifg=#c8c6c5 guibg=#85678f gui=NONE cterm=NONE
hi PmenuThumb guifg=#c8c6c5 guibg=#85678f gui=NONE cterm=NONE
...
if &term =~ 'alacritty\|xterm'
  ...
  hi DiagnosticUnderlineError guisp=#a54242 gui=undercurl cterm=undercurl
  hi DiagnosticUnderlineWarn guisp=#f0b94e gui=undercurl cterm=undercurl
  hi DiagnosticUnderlineInfo guisp=#8abeb7 gui=undercurl cterm=undercurl
  hi DiagnosticUnderlineHint guisp=#c8c6c5 gui=undercurl cterm=undercurl
  hi DiagnosticUnderlineOk guisp=#8c9440 gui=undercurl cterm=undercurl
endif
...
hi PreProc guifg=#85678f guibg=NONE gui=NONE cterm=NONE
...
hi DiagnosticUnnecessary guifg=#807970 guibg=NONE gui=NONE cterm=NONE
hi! link RustSigil RustOperator
hi! link RustStorage RustKeyword
hi! link RustFoldBraces Special
hi! link RustSelf Special
if !s:italics
  hi Comment gui=NONE cterm=NONE
endif
if has("nvim")
  hi @variable guifg=#f2a97d guibg=NONE gui=NONE cterm=NONE
  hi @function.macro guifg=#b294bb guibg=NONE gui=NONE cterm=NONE
  hi LspInlayHint guifg=#807970 guibg=NONE gui=NONE cterm=NONE
  hi! link @lsp.type.decorator PreProc
  hi! link @lsp.typemod.decorator.attribute PreProc
  hi @lsp.type.macro guifg=#b294bb guibg=NONE gui=NONE cterm=NONE
  hi! link @lsp.type.derive @lsp.type.macro
  hi! link @lsp.type.generic @lsp.type.macro
  hi! link @lsp.typemod.method.procMacro @lsp.type.macro
  hi! link @lsp.type.variable omit
  hi! link @lsp.type.character Character
  hi @lsp.type.namespace guifg=#5e8d87 guibg=NONE gui=NONE cterm=NONE
  hi @lsp.mod.crateRoot.rust guifg=#256295 guibg=NONE gui=NONE cterm=NONE
  hi! link @tag.rust_with_rstml Type
  hi! link @tag.attribute.rust_with_rstml Identifier
endif
...
if s:t_Co >= 256
  ...
  hi Pmenu ctermfg=251 ctermbg=24 cterm=NONE
  hi PmenuSbar ctermfg=251 ctermbg=24 cterm=NONE
  hi PmenuSel ctermfg=251 ctermbg=96 cterm=NONE
  hi PmenuThumb ctermfg=251 ctermbg=96 cterm=NONE
  ...
  hi DiagnosticUnnecessary ctermfg=243 ctermbg=NONE cterm=NONE
  hi! link RustSigil RustOperator
  hi! link RustStorage RustKeyword
  hi! link RustFoldBraces Special
  hi! link RustSelf Special
  ...
  if has("nvim")
    hi @variable ctermfg=216 ctermbg=NONE cterm=NONE
    hi @function.macro ctermfg=139 ctermbg=NONE cterm=NONE
    hi LspInlayHint ctermfg=243 ctermbg=NONE cterm=NONE
    hi! link @lsp.type.decorator PreProc
    hi! link @lsp.typemod.decorator.attribute PreProc
    hi @lsp.type.macro ctermfg=139 ctermbg=NONE cterm=NONE
    hi! link @lsp.type.derive @lsp.type.macro
    hi! link @lsp.type.generic @lsp.type.macro
    hi! link @lsp.typemod.method.procMacro @lsp.type.macro
    hi! link @lsp.type.variable omit
    hi! link @lsp.type.character Character
    hi @lsp.type.namespace ctermfg=66 ctermbg=NONE cterm=NONE
    hi @lsp.mod.crateRoot.rust ctermfg=24 ctermbg=NONE cterm=NONE
    hi! link @tag.rust_with_rstml Type
    hi! link @tag.attribute.rust_with_rstml Identifier
  endif
...
if s:t_Co >= 8
  ...
  hi PmenuThumb ctermfg=White ctermbg=DarkMagenta cterm=NONE
  ...
  hi DiagnosticUnnecessary ctermfg=LightGrey ctermbg=NONE cterm=NONE
  hi! link RustSigil RustOperator
  hi! link RustStorage RustKeyword
  hi! link RustFoldBraces Special
  hi! link RustSelf Special
  ...
  if has("nvim")
    hi @variable ctermfg=White ctermbg=NONE cterm=NONE
    hi @function.macro ctermfg=LightMagenta ctermbg=NONE cterm=NONE
    hi LspInlayHint ctermfg=LightGrey ctermbg=NONE cterm=NONE
    hi! link @lsp.type.decorator PreProc
    hi! link @lsp.typemod.decorator.attribute PreProc
    hi @lsp.type.macro ctermfg=LightMagenta ctermbg=NONE cterm=NONE
    hi! link @lsp.type.derive @lsp.type.macro
    hi! link @lsp.type.generic @lsp.type.macro
    hi! link @lsp.typemod.method.procMacro @lsp.type.macro
    hi! link @lsp.type.variable omit
    hi! link @lsp.type.character Character
    hi @lsp.type.namespace ctermfg=DarkCyan ctermbg=NONE cterm=NONE
    hi @lsp.mod.crateRoot.rust ctermfg=DarkBlue ctermbg=NONE cterm=NONE
    hi! link @tag.rust_with_rstml Type
    hi! link @tag.attribute.rust_with_rstml Identifier
  endif
  unlet s:t_Co s:italics
