...
" Last Updated: Tue 09 Aug 2022 10:24:18 PM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#41444a', '#a54242', '#8c9440', '#de803f', '#256295', '#85678f', '#5e8d87', '#707880', '#373b41', '#cc6666', '#b5bd68', '#f0b94e', '#5185b1', '#b294bb', '#8abeb7', '#c5c8c6']
endif
if get(g:, 'dark_transp_bg', 0) && !has('gui_running')
  hi Normal guifg=#707880 guibg=NONE gui=NONE cterm=NONE
  hi Terminal guifg=#707880 guibg=NONE gui=NONE cterm=NONE
else
...
hi CursorColumn guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi CursorLine guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
...
hi EndOfBuffer guifg=#707880 gui=NONE cterm=NONE
hi ErrorMsg guifg=#c5c8c6 guibg=#a54242 gui=NONE cterm=NONE
hi FoldColumn guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi Folded guifg=#f2a97d guibg=#381818 gui=italic cterm=italic
hi IncSearch guifg=#f2a97d guibg=#381818 gui=standout cterm=reverse
hi LineNr guifg=#f0b94e guibg=#381818 gui=NONE cterm=NONE
hi MatchParen guifg=#707880 guibg=#41444a gui=reverse cterm=reverse
hi ModeMsg guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi MoreMsg guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi NonText guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi Pmenu guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi PmenuSbar guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi PmenuSel guifg=#f2a97d guibg=#381818 gui=reverse cterm=reverse
hi PmenuThumb guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi Question guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi Search guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi SignColumn guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi SpecialKey guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
if !s:italics
...
hi StatusLine guifg=#c5c8c6 guibg=#381818 gui=reverse cterm=reverse
hi StatusLineNC guifg=#707880 guibg=#381818 gui=reverse cterm=reverse
hi TabLine guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi TabLineFill guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi TabLineSel guifg=#f2a97d guibg=#381818 gui=NONE cterm=NONE
hi Title guifg=#de803f guibg=NONE gui=NONE cterm=NONE
hi VertSplit guifg=#707880 guibg=#707880 gui=NONE cterm=NONE
hi Visual guifg=#41444a guibg=#707880 gui=NONE cterm=NONE
...
hi Constant guifg=#c5c8c6 guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#a54242 guibg=#c5c8c6 gui=reverse cterm=reverse
hi Identifier guifg=#8abeb7 guibg=NONE gui=NONE cterm=NONE
hi Ignore guifg=#707880 guibg=NONE gui=NONE cterm=NONE
...
hi Todo guifg=#707880 guibg=NONE gui=NONE cterm=NONE
hi Type guifg=#5185b1 guibg=NONE gui=NONE cterm=NONE
hi Underlined guifg=#707880 guibg=NONE gui=NONE cterm=NONE
hi CursorIM guifg=fg guibg=NONE gui=reverse cterm=reverse
hi ToolbarLine guifg=#707880 guibg=#41444a gui=NONE cterm=NONE
hi ToolbarButton guifg=#707880 guibg=#41444a gui=bold cterm=bold
if !s:italics
...
if s:t_Co >= 256
  if get(g:, 'dark_transp_bg', 0)
    hi Normal ctermfg=243 ctermbg=NONE cterm=NONE
    hi Terminal ctermfg=243 ctermbg=NONE cterm=NONE
  else
  ...
  hi CursorColumn ctermfg=216 ctermbg=52 cterm=NONE
  hi CursorLine ctermfg=216 ctermbg=52 cterm=NONE
  ...
  hi FoldColumn ctermfg=216 ctermbg=52 cterm=NONE
  hi Folded ctermfg=216 ctermbg=52 cterm=italic
  hi IncSearch ctermfg=216 ctermbg=52 cterm=reverse
  hi LineNr ctermfg=179 ctermbg=52 cterm=NONE
  hi MatchParen ctermfg=243 ctermbg=238 cterm=reverse
  hi ModeMsg ctermfg=216 ctermbg=52 cterm=NONE
  hi MoreMsg ctermfg=216 ctermbg=52 cterm=NONE
  hi NonText ctermfg=216 ctermbg=52 cterm=NONE
  hi Pmenu ctermfg=216 ctermbg=52 cterm=NONE
  hi PmenuSbar ctermfg=216 ctermbg=52 cterm=NONE
  hi PmenuSel ctermfg=216 ctermbg=52 cterm=reverse
  hi PmenuThumb ctermfg=216 ctermbg=52 cterm=NONE
  hi Question ctermfg=216 ctermbg=52 cterm=NONE
  hi Search ctermfg=216 ctermbg=52 cterm=NONE
  hi SignColumn ctermfg=216 ctermbg=52 cterm=NONE
  hi SpecialKey ctermfg=216 ctermbg=52 cterm=NONE
  if !s:italics
  ...
  hi StatusLine ctermfg=251 ctermbg=52 cterm=reverse
  hi StatusLineNC ctermfg=243 ctermbg=52 cterm=reverse
  hi TabLine ctermfg=216 ctermbg=52 cterm=NONE
  hi TabLineFill ctermfg=216 ctermbg=52 cterm=NONE
  hi TabLineSel ctermfg=216 ctermbg=52 cterm=NONE
  hi Title ctermfg=173 ctermbg=NONE cterm=NONE
  hi VertSplit ctermfg=243 ctermbg=243 cterm=NONE
  hi Visual ctermfg=238 ctermbg=243 cterm=NONE
  ...
  hi ToolbarLine ctermfg=243 ctermbg=238 cterm=NONE
  hi ToolbarButton ctermfg=243 ctermbg=238 cterm=bold
  if !s:italics
...
if s:t_Co >= 8
  ...
  hi StatusLineNC ctermfg=LightGrey ctermbg=Black cterm=reverse
...
" Color: white         #707880                   ~         LightGrey
" Color: brightblack   #373b41                   ~         DarkGrey
...
" Color: brightwhite   #c5c8c6                   ~        White
